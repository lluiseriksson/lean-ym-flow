...
- `YMFlow.WeightedGraph.heatStep_row_formula`
...
- `heatStep_row_formula` rewrites one step as the explicit neighbour-row
  formula, exposing the self coefficient `1 - tau * degree v`.
